...
def display_news(news_data):
  """Displays extracted news data in a user-friendly format.
...
if __name__ == "__main__":
  # Get user input for target URL with basic validation
  while True:
    target_url = input("Enter the URL of the financial news website: ")
    if target_url.strip():  # Check for empty input
      break
    else:
